...
<body>
    ...
    <div class="boxed_wrapper">
                        ...
                        <div class="service-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <div class="content-box">
                                    ...
                                    <div class="text">
                                        <div class="icon-box"><i class="fi-ctluxl-alfresco"></i></div>
                                        <h3>Wellness <br> Coaching</h3>
                                    </div>
                                </div>
                                <div class="overlay-content">
                                    <div class="inner">
                                        <div class="icon-box"><i class="fi-ctluxl-alfresco"></i></div>
                                        <h3><a href="sales-report.html">Wellness <br> Coaching</a></h3>
                                        <p>Guidance to create balance, manage stress, and strengthen self-care practices for a healthier, more fulfilling life.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="service-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                <div class="content-box">
                                    ...
                                    <div class="text">
                                        <div class="icon-box"><i class="fa fa-microphone"></i></div>
                                ...
                                <div class="overlay-content">
                                    <div class="inner">
                                        <div class="icon-box"><i class="fa fa-microphone"></i></div>
                                        <h3><a href="business-planning.html">Speaking & Workshops</a></h3>
                                        <p>Inspiring talks and interactive sessions on mental health, resilience, and self-compassion for individuals and organizations.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-5 col-md-12 col-sm-12 image-column">
                            <div data-animation-box="" class="image-box">
                                <figure data-animation-text="" class="overlay-anim-black-bg image" data-animation="overlay-animation"><img src="assets/images/resource/contact-1.jpg" alt=""></figure>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="project-section">
            ...
            <div class="auto-container">
                <div class="sec-title">
                    <h5 class="g_color"><i class="icon-11 g_color"></i>Blogs</h5>
