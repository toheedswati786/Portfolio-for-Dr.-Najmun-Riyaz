        <section class="main-footer">
            ...
            <div class="auto-container">
                <div class="footer-top">
                    <div class="top-inner">
                        <figure class="footer-logo" style="background-color: white; padding: 15px; border-radius:25px;"><a href="index.html"><img src="assets/images/logo.png" width="300" alt=""></a></figure>
                        <ul class="social-links clearfix">
                            ...
                            <li><a href="index.html"><i class="fas fa-butterfly"></i></a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="footer-bottom centred">
                    <p><a href="index.html">Dr. Najmun Riyaz</a> &copy; 2025 All Right Reserved</p>
                </div>
            </div>
        </section>